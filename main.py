...
import types
from custom_path_logger import logger

path_flat_iterator_1 = 'logs/flat_iterator_simple.log'


@logger(path_flat_iterator_1)
class FlatIterator:
...
path_flat_generator_1 = 'logs/flat_generator_simple.log'


@logger(path_flat_generator_1)
...
path_flat_iterator_2 = 'logs/flat_iterator_advanced.log'


@logger(path_flat_iterator_2)
class FlatIteratorAdv:
...
path_flat_generator_2 = 'logs/flat_generator_advanced.log'


@logger(path_flat_generator_2)
